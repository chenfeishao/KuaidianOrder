...
<body class="metro">
    ...
    <div class="container">
        <h1>
           	...
           	所有汇总<small>当前账户：<?php echo (session('userName')); ?></small>
        </h1>
        <div class="tile-area no-padding clearfix">
        	<?php if($list == NULL ): ?><b>当前没有汇总</b>
			<?php else: ?>
	        	<table id="table_id" class="display">
				    <thead>
				        <tr>
				            <th class="span2">报表编号</th>
				    ...
				    <tbody>
			        	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					            ...
					            <td style="text-align:center;"><?php echo ($vo["totalMoney"]); ?></td>
					            <td style="text-align:center;"><?php echo ($vo["totalNum"]); ?></td>
