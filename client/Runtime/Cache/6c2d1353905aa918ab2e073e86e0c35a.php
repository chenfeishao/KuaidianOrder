    ...
    <div class="container">
        <h1>
            <a href="<?php echo U("Index/goBack");?>"><i class="icon-arrow-left-3 fg-darker smaller"></i></a>
           	历史记录<small class="on-right"><?php echo ($title); ?></small>
        </h1>
			...
			<div class="panel">
				...
				<div class="panel-content grid fluid">
					<div class="row">
						<button class="span3 shortcut warning" onclick="window.location = '<?php echo U('Order/');?>'" data-click="transform">
                            <h2>重新全部打印</h2>
                        </button>
                        <button class="span3 shortcut primary" onclick="window.location = '<?php echo U('Order/');?>'" data-click="transform">
                            <h2>打印存根联</h2>
                        </button>
                        <button class="span3 shortcut default" onclick="window.location = '<?php echo U('Order/');?>'" data-click="transform">
                            <h2>打印发票联</h2>
                        </button>
                        <button class="span3 shortcut info" onclick="window.location = '<?php echo U('Order/');?>'" data-click="transform">
                            <h2>打印出库单</h2>
                        </button>
		            </div>
				</div>
