...
<body class="metro">
    ...
    <div class="container">
        <h1>
            ...
            费用<small class="on-right">经手人：<?php echo (session('userName')); ?>&nbsp<?php echo (session('userPower')); ?></small>
        </h1>
        <div class="tile-area no-padding clearfix">
            <div class="grid">
                <div class="tile-group three">
                    <div class="row">
                        <form id="form" method="post" action="<?php echo U("Finance/toCost");?>">
                            <fieldset>
                            	<label><font color=black>日期</font></label>
