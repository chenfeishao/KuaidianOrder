...
<body class="metro">
    ...
    <div class="container">
        <h1>
            <a href="<?php echo U("Finance/ap");?>"><i class="icon-arrow-left-3 fg-darker smaller"></i></a>
            应付款<small class="on-right">经手人：<?php echo (session('userName')); ?>&nbsp<?php echo (session('userPower')); ?></small>
        </h1>
        <div class="tile-area no-padding clearfix">
            <div class="grid">
                <div class="tile-group three">
                    <div class="row">
                        <form id="form" method="post" action="<?php echo U("Finance/toap");?>">
                            <fieldset>
                            	<label><font color=black>向何处付款</font></label>
