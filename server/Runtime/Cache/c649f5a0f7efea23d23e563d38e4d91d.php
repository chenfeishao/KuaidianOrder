            	...
            	<form id="form" method="post" action="<?php echo U("Goods/toAdd");?>">
	                ...
	                <div class="tile-group three">
	                	<div class="row">
		                    ...
		                    <div class="input-control text" data-role="input-control">
		                        <input name="bgColor" list="colorDataList" type="text" value="lightBlue" onclick='$(this).val("");'>
		                        <button type="button" class="btn-clear" tabindex="3"></button>
		                    </div>
		                    ...
		                    <div class="input-control text" data-role="input-control">
		                        <input name="brandColor" list="colorDataList" type="text" value="lightBlue" onclick='$(this).val("");'>
		                        <button type="button" class="btn-clear" tabindex="3"></button>
		                    </div>
